    ...
    <div class="row my-3">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm text-center bg-indigo text-white p-3" id="lister-despences-btn">
                <a href="{{url('etatFinanciere-Despence-Show')}}">  <h3><span class="fa fa-table"> Lister les <strong>despences</strong> </span></h3></a>
            </div>
        </div>
    </div>
    <hr>
    ...
    <form method="post" action="{{ url('store_etat') }}">
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" readonly class="form-control" name="type" id="validationDefault01" value="despence" required>
            </div>
            <div class="col-md-6 mb-3">
