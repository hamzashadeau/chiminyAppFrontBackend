...
<div class="bg">
    ...
    </header>    <div class="description"><i class="fas fa-quote-left"></i>
...
<hr>
<h1 style="width: 100%;text-align: center; border-bottom: 1px solid #000; line-height: 0.1em;margin: 10px 0 20px;"><span style=" background:#fff; padding:0 10px;">Project <strong>Detail</strong></span></h1>
<hr>
<a href="{{url('gallery.html')}}"><button type="button btn-lg" class="btn btn-primary" > <= Retour to Gallery</button></a>
...
<div class="container" style="padding-top: 0px;padding-bottom: 0px">
    ...
    <div style="margin: 0px">
        <div class="container">
            ...
            <!-- Expanded image -->
            <img id="expandedImg" src="data:image/jpg;base64,{{ chunk_split(base64_encode($projet->Projet_image1)) }}">

            <!-- Image text -->
                </div>
                    <div class="col-md-6 col-sm-12">
                        <h4><strong>description :</strong></h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis praesentium sapiente, optio quidem dolorem veritatis ipsam maxime magni ipsum ratione! Et ipsum consectetur omnis nihil porro. Placeat quis voluptate nisi.
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="column">
                <img  id="active" src="data:image/jpg;base64,{{ chunk_split(base64_encode($projet->Projet_image1)) }}" class="columnImage"  alt="Nature" onclick="myFunction(this);" >
            </div>
            <div class="column">
                <img id="modalGallery2" src="data:image/jpg;base64,{{ chunk_split(base64_encode($projet->Projet_image2)) }}" alt="Snow" class="columnImage"  onclick="myFunction(this);" >
            </div>
            <div class="column">
                <img id="modalGallery3" src="data:image/jpg;base64,{{ chunk_split(base64_encode($projet->Projet_image3)) }}" alt="Mountains" class="columnImage" onclick="myFunction(this);" >
            </div>
            <div class="column">
                <img id="modalGallery4" src="data:image/jpg;base64,{{ chunk_split(base64_encode($projet->Projet_image4)) }}" alt="Lights" class="columnImage" onclick="myFunction(this);" >
            </div>
        </div>
    </div>
</div>
